...
main: $(SRCS) $(FLEXS)
	...
	cd build && jar cvf ../lib/lexer.jar ./ast/*.class ./lexer/*.class ./type/*.class ./exception/*.class ./utils/*.class ./hierarchy/*.class ./visitors/*.class ./dataflowAnalysis/*.class $(shell find $(./tir) -name *.class);
	@echo "#!/bin/sh\n\
